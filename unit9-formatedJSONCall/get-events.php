...
if($presenter1 || $presenter2) {
    $values = array();
    $query = "SELECT name ";
    $query .= "FROM wdv341_events "; // select from the wdv341 table in my db.
    $query .= "WHERE presenter IN("; //select where the presenter name??
...
echo json_encode($products); // Encode the output to JSON object
?>