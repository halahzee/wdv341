...
//product_id, product_name, product_description, product_price, product_image, product_inStock, product_status.
$query = "SELECT product_id, product_name, product_description, product_price, product_image, product_inStock, product_status ";

$query .= 'FROM wdv341_products ORDER BY product_name DESC';
...
<body>
    ...
    <section>
        ...
        It will be replaced by the actual data. Please loop through all of your products and display them using this layout and following the instructions of the assignment. -->
        <br>
        ...
        <div class="productImage">
           ...
           ?>
            ...
            <?php 
                if($results['product_inStock'] <10){
                    $addClass = "productInventory productLowInventory";
                }else {
                    $addClass = "productInventory";
                }

            
            ?>

            <p class="productStatus"><?=$results['product_status']?></p> 

            <p class="<?php echo $addClass;?>">In Stock :<?php echo $results['product_inStock']?>
            </p>
        </div>
        <?php }?>
    </section>
