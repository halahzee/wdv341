<?php
//the time of php is global 
date_default_timezone_set('America/Chicago');
// Single line comment
$timeOfDay = date('H'); // php define date object.
//$timeOfDay = 03;
?>
<!doctype html>
<html>
...
<body>
	...
	<section>
		...
		?>
			<form method="get" action="http://localhost:8888/wdv341Class/wdv341/includes/php-basics-2.php">
